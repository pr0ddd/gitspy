...
import { InlineNote, NavItem, SectionHeader } from '@/shared/ui/parts';
...
import { splitListing, splitRecent } from '@/features/repo';
...
import { SourceRow, RepoRow, HostRepoRow } from './rows';
type Props = {
  recent: RecentRepo[];
  onOpen: () => void;

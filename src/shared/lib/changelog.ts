...
export const parseReleases = (text: string): Release[] => {
  const releases: Array<{ version: string; date: string | null; body: string[] }> = [];
...
export const notesFor = (text: string, version: string): string => {

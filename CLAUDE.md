...
Оснований два, оба замерены: `git for-each-ref` отдаёт про 1 118 ссылок react
строго больше за 10 мс против 13.2 у нашего чтения через gix, и уносит с собой
64 строки ручных починок. Подробности — в спеке `2026-08-03-branches-design.md`.
